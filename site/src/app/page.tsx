...
export default function Home() {
  return (
    <main className="site-main mx-auto flex min-h-[calc(100svh-56px)] w-full max-w-4xl flex-col justify-center px-6 py-12">
      <div className="mx-auto flex w-full max-w-[42rem] flex-col gap-6">
        <header className="flex flex-col gap-3">
          <div className="site-reveal flex items-center gap-3">
            <Logo size={48} />
          ...
          <p className="site-reveal site-reveal--delay-1 max-w-2xl text-base leading-relaxed text-neutral-600 dark:text-neutral-300">
